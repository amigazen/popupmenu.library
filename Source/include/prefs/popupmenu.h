...
struct PopupMenuPrefs
{
    ...
    UBYTE pmp_Reserved[16];	/* [0]=image set (PMP_IMAGES_*), rest reserved */
};
...
/* Built-in menu image sets (stored in pmp_Reserved[0]) */
#define PMP_IMAGES_SYSTEM	0	/* Intuition SysIClass / DrawInfo */
#define PMP_IMAGES_MM2_8	1	/* Compact MagicMenu-style (8px) */
#define PMP_IMAGES_MM2_11	2	/* Larger MagicMenu-style (11px) */
#define PMP_IMAGES_NONE		3	/* No check/amiga glyphs (submenu arrow kept) */

#define pmp_ImageSet		pmp_Reserved[0]
